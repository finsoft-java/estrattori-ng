 ...
 */
export declare class RplCalendar implements OnDestroy, OnChanges, OnInit, ControlValueAccessor {
    ...
    */
    ...
    onChange: (_: any) => void;
    onTouched: () => void;
    constructor(enabledRange: EnabledRangeService, _keyMapService: NgbDatepickerKeyMapService, _service: NgbDatepickerService, _calendar: NgbCalendar, i18n: NgbDatepickerI18n, config: NgbDatepickerConfig, _cd: ChangeDetectorRef, _elementRef: ElementRef);
    abilitaMesi(data: any): boolean;
    abilitaAnni(data: any): boolean;
    setNewTemplate(selectedTemplate: number): void;
    setMesi(position: number, selected: boolean): void;
    updateYears(startYearValue: number): void;
    setYear(yearValue: number, selected: boolean): void;
    /**
    ...
    onChangeTemplate(dataTemplate: NgbDataTemplateStruct): void;
    updateDataTemplate(date: NgbDate): void;
