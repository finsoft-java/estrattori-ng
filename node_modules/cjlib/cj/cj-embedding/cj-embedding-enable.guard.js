...
var CjEmbeddingEnableGuard = (function () {
    function CjEmbeddingEnableGuard(iframeEmbeddingService) {
        this.iframeEmbeddingService = iframeEmbeddingService;
    }
    CjEmbeddingEnableGuard.prototype.canActivate = function (route, state) {
        this.iframeEmbeddingService.isEmbeddingEnabled = true;
        return true;
    };
    return CjEmbeddingEnableGuard;
}());
CjEmbeddingEnableGuard = __decorate([
    Injectable(),
    __metadata("design:paramtypes", [CjIFrameEmbeddingService])
], CjEmbeddingEnableGuard);
export { CjEmbeddingEnableGuard };
