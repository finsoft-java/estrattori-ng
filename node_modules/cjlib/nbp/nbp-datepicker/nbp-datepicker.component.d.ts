...
export declare class NbpDatepickerComponent extends NbpInputElementBase<any> implements INbpInput {
   ...
   */
    ...
    _ngbModel: any;
    ngOnInit(): void;
    constructor(validatori: ValidatorArray, asyncValidatori: AsyncValidatorArray, parentFormContainer: NbpFormContainerComponent, element: ElementRef, inj: Injector);
    toggleOpening(): void;
