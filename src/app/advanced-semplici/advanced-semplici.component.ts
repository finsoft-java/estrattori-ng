...
@Component({
  selector: 'app-advanced-semplici',
  providers: [DemoServiceClientService],
  templateUrl: './advanced-semplici.component.html',
  styleUrls: ['./advanced-semplici.component.less']
})
export class AdvancedSempliciComponent implements OnInit {
  eventData: INbpOnRowActionEvent<Object>;
  selectionMethod = 'single';
  selectionMethod1 = 'multi';
  currentPageNumber = 1;
  ...
  constructor(private demoServiceClient: DemoServiceClientService) {
    ...
    this.gridDataSource = new NbpDataSource<Object>(this.mockData, 5);
