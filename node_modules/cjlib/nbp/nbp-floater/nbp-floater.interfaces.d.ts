/**
 * Interfaccia IButtonBoxFloaterConfigurator.
 *
 * Viene usata i pulsanti di un oggetto Floater.
 *
 * Tramite questa interfaccia è possibile definire:
 *
 ...
 */
export interface IButtonBoxFloaterConfigurator {
    icon: string;
    iconText: string;
    function?: any;
    tooltip?: string;
