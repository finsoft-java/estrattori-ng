...
@Component({
  selector: 'app-tabelle-investimenti',
  providers: [TableUtilService, DatiMockTabelleService],
  templateUrl: './tabelle-investimenti.component.html',
  styleUrls: ['./tabelle-investimenti.component.less']
})
export class TabelleInvestimentiComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.datiMockTabelleService.getTestataTabella("TabellaStandard")
      .then(value => {
    ...
    this.datiMockTabelleService.getAllClients("TabellaStandard")
      .then(value => {
        self.mockData = [...value];
