...
import { NbpAccordionEvent, INbpAccordion } from '../nbp-accordion/nbp-accordion.interfaces';
export declare class NbpAccordionShowmoreComponent implements INbpAccordion, OnInit {
    id: string;
    /**
